        ...
        <div className='w-11/12 lg:w-3/4 mx-auto pt-20 lg:pt-32' id='services'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                <div data-aos="fade-right" className='border cursor-default rounded-lg p-4 shadow2 duration-200 bg-[#181818] border-whtie'>
                    <h4 className='rounded-lg px-3 py-2 font-semibold mb-5 bg-[#008f40] text-white text-2xl'>Frontend Development</h4>
                ...
                <div data-aos="fade-up" className='border cursor-default rounded-lg p-4 shadow2 duration-200 bg-[#181818] border-whtie'>
                ...
                <div data-aos="fade-left" className='border cursor-default rounded-lg p-4 shadow2 duration-200 bg-[#181818] border-whtie'>
