            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                ...
                <div className=''>
                    ...
                    <div className='grid lg:grid-cols-3 md:grid-cols-3 grid-cols-2 gap-10 mb-10'>
                        <div className='border flex flex-col justify-center items-center p-4 border-[#159e53] shadow2 cursor-pointer rounded-lg w-full h-48'>
                    ...
                    <div className='grid lg:grid-cols-2 pt-8 md:grid-cols-2 grid-cols-1 gap-10'>
                        <div className='border border-[#159e53] p-4 shadow2 cursor-pointer rounded-lg w-full'>
