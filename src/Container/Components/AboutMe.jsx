            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-10 mt-10'>
                <div className='lg:col-span-2'>
                    ...
                    <p className='flex flex-wrap gap-5'>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>HTML5</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>CSS3</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Tailwind CSS</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Bootstrap</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>JavaScript</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>ES6</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>ReactJS</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Firebase</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Express</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>MongoDB</span>
                        <span className='bg-[#242424] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>NodeJS</span>
                    </p>
                </div>
                <div>
                    <h2 className="text-2xl font-semibold mb-6 primary-color">TOOLS</h2>
                    <div className='flex flex-wrap gap-5'>
                        <div class="bg-[#242424] shadow2 duration-200 p-5 rounded-md"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="text-4xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M16 3v18l4 -2.5v-13z"></path><path d="M9.165 13.903l-4.165 3.597l-2 -1l4.333 -4.5m1.735 -1.802l6.932 -7.198v5l-4.795 4.141"></path><path d="M16 16.5l-11 -10l-2 1l13 13.5"></path></svg></div>
