    ...
    return (
        <div className='text-white overflow-hidden lg:w-3/4 w-11/12 mx-auto pt-20 lg:pt-32' id='about'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-10'>
                <Slide direction='down' className='hidden lg:block md:block'>
            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-10 mt-10'>
                <Slide direction='left' className='lg:col-span-2'>
                    <div>
                        ...
                        <p className='flex flex-wrap gap-5'>
                            ...
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>CSS3</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Tailwind CSS</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Bootstrap</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>JavaScript</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>ES6</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>ReactJS</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Firebase</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>Express</span>
                            <span className='bg-[#242424] border border-[#242424] hover:border-[#159e53] cursor-default shadow2 duration-200 px-4 py-2 rounded-md'>MongoDB</span>
