...
const Banner = () => {
    ...
    return (
        <div>
            <div className='lg:bg-[url(/banner2.jpg)] h-screen overflow-hidden bg-[url(/banner2-phone.jpg)] bg-cover bg-center lg:bg-left-top'>
                <div className='h-screen bg-gradient-to-r from-[#181818] lg:via-[#181818d6] justify-center items-center text-white'>
                    <div className='flex justify-between items-center relative h-screen'>
                        <Slide direction='left'>
                            <div className='lg:w-[65%] w-11/12 mx-auto'>
                                ...
                                <div>
                                    <p className='lg:w-4/5 md:w-2/3 border-l-4 mb-3 mt-4 pl-5 primary-border-color flex'>I'm a fullstack web developer with expertise in ReactJS, MongoDB, Express, and NodeJS. Along with my development skills, I also have a strong knowledge of competitive programming.</p>
                                </div>
